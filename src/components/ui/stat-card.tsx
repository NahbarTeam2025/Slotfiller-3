...
export function StatCard({ title, value, subtitle, icon, className, valueClassName }: StatCardProps) {
  return (
    <div className={cn("rounded-xl bg-white dark:bg-slate-900 p-6 shadow-sm border border-gray-100 dark:border-slate-800", className)}>
      ...
      <div className={cn("text-4xl font-bold text-deep-blue dark:text-white", valueClassName)}>{value}</div>
